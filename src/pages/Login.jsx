...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 page-transition relative">
      {!showForm ? (
        ...
        <div className="w-full max-w-md bg-[#1e1e1e] border border-[#2a2a2a] rounded-3xl p-6 shadow-2xl relative animate-in zoom-in-95 duration-200">
          <button onClick={() => setShowForm(false)} className="absolute top-6 left-6 text-gray-500 hover:text-white transition">
            <ChevronLeft size={24} />
          </button>
          ...
          <div className="flex flex-col items-center justify-center mb-8 mt-4">
            ...
            <p className="text-gray-400 text-sm mt-1">{isSignUp ? 'Crea il tuo account' : 'Accedi alla tua dashboard'}</p>
          </div>
