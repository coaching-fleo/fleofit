...
> Stato al **26 agosto 2026**, fine giornata. `npm test` → **169** · `npm run lint` → **42**.
...
| 18 | **1.447 valori hex letterali** contro i token di `@theme` (ricontati il 26/08; 1.336 solo in `src/pages`) | 2-3 giorni | Il rebranding che PRODUCT.md indica come possibile sarebbe un find&replace su 1.447 punti. **È l'ultimo fronte grosso non congelato**, ora che 15, 17, 19 e 21 sono chiusi o riclassificati |
